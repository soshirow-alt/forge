-- Staging / later Production APPLY: Owner Dashboard SQL Editor only.
-- Same as supabase/migrations/104_feedback_arrived_owner_notify.sql
-- Then apply apply_feedback_arrived_notify_105.sql (concurrency harden).
