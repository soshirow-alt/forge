...
最終更新：**2026-06-25**（Preview RUN d3a3540 — マイコミュニティ mock UI + ホーム伸びランキング）
...
- **マイコミュニティ UI mock 準拠** — ヘッダーカード・折りたたみ compose・Devlog 引用カード・参加申請メッセージ/空状態（Preview RUN d3a3540）
...
- **Studio ヒーロー3モード** — pre_cycle / in_cycle / cycle_complete。共有ボタン→URLコピー。設定折りたたみ
- **Studio ホーム/一覧整理** — サンプルカルーセル削除、フェーズピル、実作品ワッペンのみ
- **実 Studio UX 大改修**（2026-06-19）— ヒーローCTA・イベント駆動サイクル・空ボックス非表示・正式版宣言折りたたみ
