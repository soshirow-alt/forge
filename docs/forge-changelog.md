...
- **設定** — 未接続の通知・プライバシートグル（フォロー中の開発者、コミュニティ、Forgeお知らせ、見届け人/プレイ/コミュニティ通知、プロフィール公開・活動表示・ランキング表示）を disabled +「近日対応」表示。実際に効く項目（更新追跡通知、開発者プロフィール公開、アカウント系）は従来どおり操作可能
