...
## 2026-07-06 — 投稿完了画面の共有導線整理（preview/landing-01）

- **投稿成功パネル** — 見出し「作品を投稿しました」+ 作品タイトル表示。説明文を公開ページ確認・共有・Studio編集の流れに整理
- **CTA** — 「公開ページを見る」（最優先）/ 「外部に共有する」/ 「Studioで作品を編集する」/ 「続けて投稿する」（軽量）
- **非公開** — 公開ページCTAは非活性、公開設定の説明と Studio 編集を強調
- **遷移** — 投稿完了後も `/studio/submit` 上で成功カード表示（従来どおり）。`/submit` はリダイレクトのみ
- **DB / auth 変更なし**
