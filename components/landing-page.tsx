...
function LandingPageCanvas({ className = "" }: { className?: string }) {
  return (
    ...
    >
      <div className="pointer-events-none absolute left-0 top-0 overflow-hidden" style={{ width: MOCK_W, height: MOCK_HERO_BG_H }}>
        <Image
      ...
      <section
        ...
        style={{ top: MOCK_FEATURED.y, width: MOCK_W, height: MOCK_NEWS.y - MOCK_FEATURED.y }}
      >
        <div
        ...
        {featuredGames.map((game, index) => {
          ...
          return (
            <article
              ...
              style={{ left: x, top: y, width: MOCK_FEATURED.cardW }}
            >
              <div className={game.thumbClass} style={{ height: MOCK_FEATURED.thumbH }} />
              <div style={{ padding: MOCK_FEATURED.metaPad, minHeight: MOCK_FEATURED.metaH }}>
                ...
                <div className="mt-1 flex gap-2 text-violet-400/90" style={{ fontSize: 8 }}>
      ...
      <section
        className="absolute left-0 z-10 border-y border-zinc-800/60 bg-[#0c0c12]"
      ...
      >
        ...
        >
          <div className="min-w-0">
            <h2 className="font-semibold text-white" style={{ fontSize: MOCK_NEWS.titleSize }}>
              Forge からのお知らせ
            </h2>
      ...
      <footer
        className="absolute left-0 z-10 bg-[#08080c]"
  ...
  return (
    <div className="min-h-dvh bg-[#08080c] text-zinc-100 lg:hidden">
      <div className="relative h-48 overflow-hidden">
        <Image src="/images/landing-mock-reference.jpg" alt="" fill className="object-cover object-left-top" sizes="100vw" />
...
/** オーバーレイ比較 — /landing/overlay */
export function LandingPageOverlayCompare({ opacity = 0.5 }: { opacity?: number }) {
  return (
    <div className="relative bg-[#050508]" style={{ width: MOCK_W, height: MOCK_H }}>
      <Image
        src="/images/landing-mock-reference.jpg"
        alt="モック基準"
        width={MOCK_W}
        ...
        style={{ width: MOCK_W, height: MOCK_H }}
      />
      <div className="absolute left-0 top-0" style={{ width: MOCK_W, height: MOCK_H, opacity }}>
        <LandingPageCanvas />
      </div>
    </div>
  );
