      ...
      <div className="flex flex-col gap-4 md:flex-row md:items-stretch md:gap-5">
        ...
        <div className="flex min-w-0 flex-1 gap-3 sm:gap-4">
          ...
          <div className="min-w-0 flex-1">
            ...
            {dev.bio ? (
              <p className="mt-2 line-clamp-2 whitespace-pre-wrap break-words text-sm text-zinc-400">
                {dev.bio}
              </p>
            ) : null}
          ...
          >
            {featured.map((work) => (
              <li key={work.id} className="min-w-0">
                ...
                {"phase" in work && work.phase ? (
                  <p className="truncate text-[10px] text-zinc-600">{work.phase}</p>
                ) : null}
              </li>
            ))}
          </ul>
