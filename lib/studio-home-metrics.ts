...
export const STUDIO_HOME_DEV_HINTS = [
  {
    id: "voice-prompts",
    title: "プレイヤーのフィードバックが届きやすい問いの作り方",
    ...
    paragraphs: [
      "プレイ直後に答えられる粒度にすると、初回フィードバックのハードルが下がります。",
  ...
  },
  {
    ...
    paragraphs: [
      ...
      "短い Devlog でも、問いとのセットで届けるとフィードバックの質が上がりやすいです。",
    ],
  },
  {
    ...
    lead: "反応が少ないときは、まず「遊ばれたか」「フィードバックを送る理由があるか」を見直します。",
    paragraphs: [
