/** Studio 右パネル — 左プレビューと差別化した操作エリア用 */
...
export const studioOperationPanelOuterClassName =
  "w-full min-w-0 max-w-full box-border rounded-2xl border border-orange-500/25 bg-zinc-900/75 px-4 py-4 shadow-sm shadow-orange-500/10";

export const studioOperationPanelHeaderAccentClassName =
  "w-full min-w-0 max-w-full box-border rounded-xl border border-orange-500/15 bg-gradient-to-br from-orange-500/12 via-orange-500/6 to-transparent px-3 py-3";

export const studioOperationPanelBlockClassName =
  "w-full min-w-0 max-w-full box-border rounded-xl border border-orange-500/12 bg-zinc-900/55 p-4";
