...
export const mockNotifications: NotificationV0Item[] = [
  {
    ...
    body: "「星灯の旅路」へのあなたのフィードバックに、5人が共感しました。",
    timeLabel: "5分前",
    read: false,
  ...
  },
  {
    ...
    kind: "empathy",
    title: "フィードバックに共感が付きました",
    body: "「炉心の残光」へのあなたのフィードバックに、2人が共感しました。",
    timeLabel: "昨日 22:15",
    read: true,
  ...
  },
  {
    id: "n7",
    kind: "developer_post",
    title: "フォロー中の開発者が新作を公開しました",
    body: "フォロー中の GreenSmith が「森の中の小さな工房」を公開しました。プレイしてフィードバックを送れます。",
    timeLabel: "昨日 12:30",
    read: true,
    href: "/games/mori-no-kobana-kobo",
    thumbnail: "/images/landing/game-5.png",
  },
  {
    id: "n8",
    kind: "new_feedback",
    title: "見届け中の作品に新しいフィードバックがあります",
    body: "あなたが見届けている「夏の向こう側」に、他のプレイヤーからフィードバックが届きました。",
    timeLabel: "2日前",
    read: true,
